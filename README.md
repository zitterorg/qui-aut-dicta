...
<a href="https://opencollective.com/@zitterorg/qui-aut-dicta#backers" target="_blank"><img src="https://opencollective.com/@zitterorg/qui-aut-dicta/backers.svg?width=890"></a>
...
Now it's deprecated in favor of separate inclusion of required parts of `@zitterorg/qui-aut-dicta` and `regenerator-runtime` and, for preventing breaking changes, left on `@zitterorg/qui-aut-dicta@2`.
...
```
Modules [`es.number.epsilon`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.number.epsilon.js), [`es.number.is-finite`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.number.is-finite.js), [`es.number.is-integer`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.number.is-integer.js), [`es.number.is-nan`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.number.is-nan.js), [`es.number.is-safe-integer`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.number.is-safe-integer.js), [`es.number.max-safe-integer`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.number.max-safe-integer.js), [`es.number.min-safe-integer`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.number.min-safe-integer.js), [`es.number.parse-float`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.number.parse-float.js), [`es.number.parse-int`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.number.parse-int.js), [`es.number.to-exponential`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.number.to-exponential.js), [`es.number.to-fixed`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.number.to-fixed.js), [`es.number.to-precision`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.number.to-precision.js), [`es.parse-int`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.parse-int.js), [`es.parse-float`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.parse-float.js).
```js
class Number {
...
Modules [`es.symbol`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.symbol.js), [`es.symbol.async-iterator`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.symbol.async-iterator.js), [`es.symbol.description`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.symbol.description.js), [`es.symbol.has-instance`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.symbol.has-instance.js), [`es.symbol.is-concat-spreadable`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.symbol.is-concat-spreadable.js), [`es.symbol.iterator`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.symbol.iterator.js), [`es.symbol.match`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.symbol.match.js), [`es.symbol.replace`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.symbol.replace.js), [`es.symbol.search`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.symbol.search.js), [`es.symbol.species`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.symbol.species.js), [`es.symbol.split`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.symbol.split.js), [`es.symbol.to-primitive`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.symbol.to-primitive.js), [`es.symbol.to-string-tag`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.symbol.to-string-tag.js), [`es.symbol.unscopables`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.symbol.unscopables.js), [`es.math.to-string-tag`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.math.to-string-tag.js).
```js
class Symbol {
...
[*CommonJS entry points:*](#commonjs-api)
```
@zitterorg/qui-aut-dicta(-pure)/es|stable|actual|full/symbol
@zitterorg/qui-aut-dicta(-pure)/es|stable|actual|full/symbol/async-iterator
@zitterorg/qui-aut-dicta/es|stable|actual|full/symbol/description
@zitterorg/qui-aut-dicta(-pure)/es|stable|actual|full/symbol/has-instance
@zitterorg/qui-aut-dicta(-pure)/es|stable|actual|full/symbol/is-concat-spreadable
@zitterorg/qui-aut-dicta(-pure)/es|stable|actual|full/symbol/iterator
@zitterorg/qui-aut-dicta(-pure)/es|stable|actual|full/symbol/match
@zitterorg/qui-aut-dicta(-pure)/es|stable|actual|full/symbol/replace
@zitterorg/qui-aut-dicta(-pure)/es|stable|actual|full/symbol/search
@zitterorg/qui-aut-dicta(-pure)/es|stable|actual|full/symbol/species
@zitterorg/qui-aut-dicta(-pure)/es|stable|actual|full/symbol/split
@zitterorg/qui-aut-dicta(-pure)/es|stable|actual|full/symbol/to-primitive
@zitterorg/qui-aut-dicta(-pure)/es|stable|actual|full/symbol/to-string-tag
@zitterorg/qui-aut-dicta(-pure)/es|stable|actual|full/symbol/unscopables
@zitterorg/qui-aut-dicta(-pure)/es|stable|actual|full/symbol/for
@zitterorg/qui-aut-dicta(-pure)/es|stable|actual|full/symbol/key-for
@zitterorg/qui-aut-dicta(-pure)/es|stable|actual|full/object/get-own-property-symbols
@zitterorg/qui-aut-dicta(-pure)/es|stable|actual|full/math/to-string-tag
```
...
```
- Currently, `@zitterorg/qui-aut-dicta` does not add setters to `Object.prototype` for well-known symbols for correct work something like `Symbol.iterator in foo`. It can cause problems with their enumerability.
- Some problems are possible with environment exotic objects (for example, IE `localStorage`).

#### ECMAScript: Collections[⬆](#index)
`@zitterorg/qui-aut-dicta` uses native collections in most cases, just fixes methods / constructor, if it's required, and in the old environment uses fast polyfill (O(1) lookup).
#### Map[⬆](#index)
Modules [`es.map`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.map.js) and [`es.map.group-by`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.map.group-by.js).
```js
class Map {
...
[*CommonJS entry points:*](#commonjs-api)
```
@zitterorg/qui-aut-dicta(-pure)/es|stable|actual|full/map
@zitterorg/qui-aut-dicta(-pure)/es|stable|actual|full/map/group-by
```
...
```
#### Set[⬆](#index)
Modules [`es.set`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.set.js), [`es.set.difference.v2`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.set.difference.v2.js), [`es.set.intersection.v2`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.set.intersection.v2.js), [`es.set.is-disjoint-from.v2`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.set.is-disjoint-from.v2.js), [`es.set.is-subset-of.v2`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.set.is-subset-of.v2.js), [`es.set.is-superset-of.v2`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.set.is-superset-of.v2.js), [`es.set.symmetric-difference.v2`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.set.symmetric-difference.v2.js), [`es.set.union.v2`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.set.union.v2.js)
```js
class Set {
...
[*CommonJS entry points:*](#commonjs-api)
```
@zitterorg/qui-aut-dicta(-pure)/es|stable|actual|full/set
@zitterorg/qui-aut-dicta(-pure)/es|stable|actual|full/set/difference
@zitterorg/qui-aut-dicta(-pure)/es|stable|actual|full/set/intersection
@zitterorg/qui-aut-dicta(-pure)/es|stable|actual|full/set/is-disjoint-from
@zitterorg/qui-aut-dicta(-pure)/es|stable|actual|full/set/is-subset-of
@zitterorg/qui-aut-dicta(-pure)/es|stable|actual|full/set/is-superset-of
@zitterorg/qui-aut-dicta(-pure)/es|stable|actual|full/set/symmetric-difference
@zitterorg/qui-aut-dicta(-pure)/es|stable|actual|full/set/union
```
...
```
#### WeakMap[⬆](#index)
Module [`es.weak-map`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.weak-map.js).
```js
class WeakMap {
...
[*CommonJS entry points:*](#commonjs-api)
```
@zitterorg/qui-aut-dicta(-pure)/es|stable|actual|full/weak-map
```
...
```
#### WeakSet[⬆](#index)
Module [`es.weak-set`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.weak-set.js).
```js
class WeakSet {
...
[*CommonJS entry points:*](#commonjs-api)
```
@zitterorg/qui-aut-dicta(-pure)/es|stable|actual|full/weak-set
```
...
Modules [`es.array-buffer.constructor`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.array-buffer.constructor.js), [`es.array-buffer.is-view`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.array-buffer.is-view.js), [`esnext.array-buffer.detached`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.array-buffer.detached.js), [`es.array-buffer.slice`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.array-buffer.slice.js), [`esnext.array-buffer.transfer`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.array-buffer.transfer.js), [`esnext.array-buffer.transfer-to-fixed-length`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.array-buffer.transfer-to-fixed-length.js) [`es.data-view`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.data-view.js), [`es.typed-array.int8-array`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.typed-array.int8-array.js), [`es.typed-array.uint8-array`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.typed-array.uint8-array.js), [`es.typed-array.uint8-clamped-array`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.typed-array.uint8-clamped-array.js), [`es.typed-array.int16-array`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.typed-array.int16-array.js), [`es.typed-array.uint16-array`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.typed-array.uint16-array.js), [`es.typed-array.int32-array`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.typed-array.int32-array.js), [`es.typed-array.uint32-array`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.typed-array.uint32-array.js), [`es.typed-array.float32-array`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.typed-array.float32-array.js), [`es.typed-array.float64-array`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.typed-array.float64-array.js), [`es.typed-array.copy-within`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.typed-array.copy-within.js), [`es.typed-array.every`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.typed-array.every.js), [`es.typed-array.fill`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.typed-array.fill.js), [`es.typed-array.filter`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.typed-array.filter.js), [`es.typed-array.find`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.typed-array.find.js), [`es.typed-array.find-index`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.typed-array.find-index.js), [`es.typed-array.find-last`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.typed-array.find-last.js), [`es.typed-array.find-last-index`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.typed-array.find-last-index.js), [`es.typed-array.for-each`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.typed-array.for-each.js), [`es.typed-array.from`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.typed-array.from.js), [`es.typed-array.includes`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.typed-array.includes.js), [`es.typed-array.index-of`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.typed-array.index-of.js), [`es.typed-array.iterator`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.typed-array.iterator.js), [`es.typed-array.last-index-of`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.typed-array.last-index-of.js), [`es.typed-array.map`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.typed-array.map.js), [`es.typed-array.of`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.typed-array.of.js), [`es.typed-array.reduce`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.typed-array.reduce.js), [`es.typed-array.reduce-right`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.typed-array.reduce-right.js), [`es.typed-array.reverse`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.typed-array.reverse.js), [`es.typed-array.set`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.typed-array.set.js), [`es.typed-array.slice`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.typed-array.slice.js), [`es.typed-array.some`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.typed-array.some.js), [`es.typed-array.sort`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.typed-array.sort.js), [`es.typed-array.subarray`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.typed-array.subarray.js), [`es.typed-array.to-locale-string`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.typed-array.to-locale-string.js), [`es.typed-array.to-string`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.typed-array.to-string.js), [`es.typed-array.at`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.typed-array.at.js), [`es.typed-array.to-reversed`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.typed-array.to-reversed.js), [`es.typed-array.to-sorted`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.typed-array.to-sorted.js), [`es.typed-array.with`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.typed-array.with.js).
```js
class ArrayBuffer {
...
[*CommonJS entry points:*](#commonjs-api)
```
@zitterorg/qui-aut-dicta/es|stable|actual|full/array-buffer
@zitterorg/qui-aut-dicta/es|stable|actual|full/array-buffer/constructor
@zitterorg/qui-aut-dicta/es|stable|actual|full/array-buffer/is-view
@zitterorg/qui-aut-dicta/es|stable|actual|full/array-buffer/detached
@zitterorg/qui-aut-dicta/es|stable|actual|full/array-buffer/slice
@zitterorg/qui-aut-dicta/es|stable|actual|full/array-buffer/transfer
@zitterorg/qui-aut-dicta/es|stable|actual|full/array-buffer/transfer-to-fixed-length
@zitterorg/qui-aut-dicta/es|stable|actual|full/data-view
@zitterorg/qui-aut-dicta/es|stable|actual|full/typed-array
@zitterorg/qui-aut-dicta/es|stable|actual|full/typed-array/int8-array
@zitterorg/qui-aut-dicta/es|stable|actual|full/typed-array/uint8-array
@zitterorg/qui-aut-dicta/es|stable|actual|full/typed-array/uint8-clamped-array
@zitterorg/qui-aut-dicta/es|stable|actual|full/typed-array/int16-array
@zitterorg/qui-aut-dicta/es|stable|actual|full/typed-array/uint16-array
@zitterorg/qui-aut-dicta/es|stable|actual|full/typed-array/int32-array
@zitterorg/qui-aut-dicta/es|stable|actual|full/typed-array/uint32-array
@zitterorg/qui-aut-dicta/es|stable|actual|full/typed-array/float32-array
@zitterorg/qui-aut-dicta/es|stable|actual|full/typed-array/float64-array
@zitterorg/qui-aut-dicta/es|stable|actual|full/typed-array/at
@zitterorg/qui-aut-dicta/es|stable|actual|full/typed-array/copy-within
@zitterorg/qui-aut-dicta/es|stable|actual|full/typed-array/entries
@zitterorg/qui-aut-dicta/es|stable|actual|full/typed-array/every
@zitterorg/qui-aut-dicta/es|stable|actual|full/typed-array/fill
@zitterorg/qui-aut-dicta/es|stable|actual|full/typed-array/filter
@zitterorg/qui-aut-dicta/es|stable|actual|full/typed-array/find
@zitterorg/qui-aut-dicta/es|stable|actual|full/typed-array/find-index
@zitterorg/qui-aut-dicta/es|stable|actual|full/typed-array/find-last
@zitterorg/qui-aut-dicta/es|stable|actual|full/typed-array/find-last-index
@zitterorg/qui-aut-dicta/es|stable|actual|full/typed-array/for-each
@zitterorg/qui-aut-dicta/es|stable|actual|full/typed-array/from
@zitterorg/qui-aut-dicta/es|stable|actual|full/typed-array/includes
@zitterorg/qui-aut-dicta/es|stable|actual|full/typed-array/index-of
@zitterorg/qui-aut-dicta/es|stable|actual|full/typed-array/iterator
@zitterorg/qui-aut-dicta/es|stable|actual|full/typed-array/join
@zitterorg/qui-aut-dicta/es|stable|actual|full/typed-array/keys
@zitterorg/qui-aut-dicta/es|stable|actual|full/typed-array/last-index-of
@zitterorg/qui-aut-dicta/es|stable|actual|full/typed-array/map
@zitterorg/qui-aut-dicta/es|stable|actual|full/typed-array/of
@zitterorg/qui-aut-dicta/es|stable|actual|full/typed-array/reduce
@zitterorg/qui-aut-dicta/es|stable|actual|full/typed-array/reduce-right
@zitterorg/qui-aut-dicta/es|stable|actual|full/typed-array/reverse
@zitterorg/qui-aut-dicta/es|stable|actual|full/typed-array/set
@zitterorg/qui-aut-dicta/es|stable|actual|full/typed-array/slice
@zitterorg/qui-aut-dicta/es|stable|actual|full/typed-array/some
@zitterorg/qui-aut-dicta/es|stable|actual|full/typed-array/sort
@zitterorg/qui-aut-dicta/es|stable|actual|full/typed-array/subarray
@zitterorg/qui-aut-dicta/es|stable|actual|full/typed-array/to-locale-string
@zitterorg/qui-aut-dicta/es|stable|actual|full/typed-array/to-reversed
@zitterorg/qui-aut-dicta/es|stable|actual|full/typed-array/to-sorted
@zitterorg/qui-aut-dicta/es|stable|actual|full/typed-array/to-string
@zitterorg/qui-aut-dicta/es|stable|actual|full/typed-array/values
@zitterorg/qui-aut-dicta/es|stable|actual|full/typed-array/with
```
...
Modules [`es.reflect.apply`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.reflect.apply.js), [`es.reflect.construct`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.reflect.construct.js), [`es.reflect.define-property`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.reflect.define-property.js), [`es.reflect.delete-property`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.reflect.delete-property.js), [`es.reflect.get`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.reflect.get.js), [`es.reflect.get-own-property-descriptor`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.reflect.get-own-property-descriptor.js), [`es.reflect.get-prototype-of`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.reflect.get-prototype-of.js), [`es.reflect.has`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.reflect.has.js), [`es.reflect.is-extensible`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.reflect.is-extensible.js), [`es.reflect.own-keys`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.reflect.own-keys.js), [`es.reflect.prevent-extensions`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.reflect.prevent-extensions.js), [`es.reflect.set`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.reflect.set.js), [`es.reflect.set-prototype-of`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.reflect.set-prototype-of.js).
```js
namespace Reflect {
...
[*CommonJS entry points:*](#commonjs-api)
```
@zitterorg/qui-aut-dicta(-pure)/es|stable|actual|full/reflect
@zitterorg/qui-aut-dicta(-pure)/es|stable|actual|full/reflect/apply
@zitterorg/qui-aut-dicta(-pure)/es|stable|actual|full/reflect/construct
@zitterorg/qui-aut-dicta(-pure)/es|stable|actual|full/reflect/define-property
@zitterorg/qui-aut-dicta(-pure)/es|stable|actual|full/reflect/delete-property
@zitterorg/qui-aut-dicta(-pure)/es|stable|actual|full/reflect/get
@zitterorg/qui-aut-dicta(-pure)/es|stable|actual|full/reflect/get-own-property-descriptor
@zitterorg/qui-aut-dicta(-pure)/es|stable|actual|full/reflect/get-prototype-of
@zitterorg/qui-aut-dicta(-pure)/es|stable|actual|full/reflect/has
@zitterorg/qui-aut-dicta(-pure)/es|stable|actual|full/reflect/is-extensible
@zitterorg/qui-aut-dicta(-pure)/es|stable|actual|full/reflect/own-keys
@zitterorg/qui-aut-dicta(-pure)/es|stable|actual|full/reflect/prevent-extensions
@zitterorg/qui-aut-dicta(-pure)/es|stable|actual|full/reflect/set
@zitterorg/qui-aut-dicta(-pure)/es|stable|actual|full/reflect/set-prototype-of
```
...
Since `JSON` object is missed only in very old engines like IE7-, `@zitterorg/qui-aut-dicta` does not provide a full `JSON` polyfill, however, fix already existing implementations by the current standard, for example, [well-formed `JSON.stringify`](https://github.com/tc39/proposal-well-formed-stringify). `JSON` is also fixed in other modules - for example, `Symbol` polyfill fixes `JSON.stringify` for correct work with symbols.

Module [`es.json.to-string-tag`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.json.to-string-tag.js) and [`es.json.stringify`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.json.stringify.js).
```js
namespace JSON {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta(-pure)/es|stable|actual|full/json/stringify
@zitterorg/qui-aut-dicta(-pure)/es|stable|actual|full/json/to-string-tag
```
...
Module [`es.global-this`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/es.global-this.js).
```js
let globalThis: GlobalThisValue;
```
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta(-pure)/es|stable|actual|full/global-this
```
...
Finished (stage 4) proposals already marked in `@zitterorg/qui-aut-dicta` as stable ECMAScript, they are available in `@zitterorg/qui-aut-dicta/stable` and `@zitterorg/qui-aut-dicta/es` namespace, you can find them in related sections of the README. However, even for finished proposals, `@zitterorg/qui-aut-dicta` provides a way to include only features for a specific proposal like `@zitterorg/qui-aut-dicta/proposals/proposal-name`.
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta/proposals/global-this
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@zitterorg/qui-aut-dicta/proposals/relative-indexing-method
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@zitterorg/qui-aut-dicta/proposals/array-includes
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@zitterorg/qui-aut-dicta/proposals/array-flat-map
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@zitterorg/qui-aut-dicta/proposals/array-find-from-last
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@zitterorg/qui-aut-dicta/proposals/change-array-by-copy-stage-4
@zitterorg/qui-aut-dicta(-pure)/es|stable|actual|full/array(/virtual)/to-reversed
@zitterorg/qui-aut-dicta(-pure)/es|stable|actual|full/array(/virtual)/to-sorted
@zitterorg/qui-aut-dicta(-pure)/es|stable|actual|full/array(/virtual)/to-spliced
@zitterorg/qui-aut-dicta(-pure)/es|stable|actual|full/array(/virtual)/with
...
[*CommonJS entry points:*](#commonjs-api)
```
@zitterorg/qui-aut-dicta/proposals/array-grouping-v2
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta/proposals/array-buffer-transfer
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@zitterorg/qui-aut-dicta/proposals/object-values-entries
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@zitterorg/qui-aut-dicta/proposals/object-from-entries
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@zitterorg/qui-aut-dicta/proposals/object-getownpropertydescriptors
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@zitterorg/qui-aut-dicta/proposals/accessible-object-hasownproperty
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@zitterorg/qui-aut-dicta/proposals/string-padding
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta/proposals/string-match-all
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta/proposals/string-replace-all-stage-4
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta/proposals/string-left-right-trim
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta/proposals/regexp-dotall-flag
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta/proposals/regexp-named-groups
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta/proposals/promise-all-settled
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta/proposals/promise-any
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta/proposals/promise-finally
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta/proposals/promise-with-resolvers
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta/proposals/async-iteration
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta/proposals/symbol-description
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta/proposals/well-formed-stringify
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta/proposals/well-formed-unicode-strings
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta/proposals/set-methods-v2
```

#### Stage 3 proposals[⬆](#index)

`@zitterorg/qui-aut-dicta/stage/3` entry point contains only stage 3 proposals, `@zitterorg/qui-aut-dicta/stage/2.7` - stage 2.7 and stage 3, etc.

[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta(-pure)/stage/3
```
##### [`Iterator` helpers](https://github.com/tc39/proposal-iterator-helpers)[⬆](#index)
Modules [`esnext.iterator.constructor`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.iterator.constructor.js), [`esnext.iterator.drop`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.iterator.drop.js), [`esnext.iterator.every`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.iterator.every.js), [`esnext.iterator.filter`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.iterator.filter.js), [`esnext.iterator.find`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.iterator.find.js), [`esnext.iterator.flat-map`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.iterator.flat-map.js), [`esnext.iterator.for-each`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.iterator.for-each.js), [`esnext.iterator.from`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.iterator.from.js), [`esnext.iterator.map`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.iterator.map.js), [`esnext.iterator.reduce`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.iterator.reduce.js), [`esnext.iterator.some`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.iterator.some.js), [`esnext.iterator.take`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.iterator.take.js), [`esnext.iterator.to-array`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.iterator.to-array.js)
```js
class Iterator {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta/proposals/iterator-helpers-stage-3-2
@zitterorg/qui-aut-dicta(-pure)/actual|full/iterator
@zitterorg/qui-aut-dicta(-pure)/actual|full/iterator/drop
@zitterorg/qui-aut-dicta(-pure)/actual|full/iterator/every
@zitterorg/qui-aut-dicta(-pure)/actual|full/iterator/filter
@zitterorg/qui-aut-dicta(-pure)/actual|full/iterator/find
@zitterorg/qui-aut-dicta(-pure)/actual|full/iterator/flat-map
@zitterorg/qui-aut-dicta(-pure)/actual|full/iterator/for-each
@zitterorg/qui-aut-dicta(-pure)/actual|full/iterator/from
@zitterorg/qui-aut-dicta(-pure)/actual|full/iterator/map
@zitterorg/qui-aut-dicta(-pure)/actual|full/iterator/reduce
@zitterorg/qui-aut-dicta(-pure)/actual|full/iterator/some
@zitterorg/qui-aut-dicta(-pure)/actual|full/iterator/take
@zitterorg/qui-aut-dicta(-pure)/actual|full/iterator/to-array
```
...
Modules [`esnext.array.from-async`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.array.from-async.js).
```js
class Array {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta/proposals/array-from-async-stage-2
@zitterorg/qui-aut-dicta(-pure)/actual|full/array/from-async
```
...
Modules [`esnext.json.is-raw-json`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.json.is-raw-json.js), [`esnext.json.parse`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.json.parse.js), [`esnext.json.raw-json`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.json.raw-json.js).
```js
namespace JSON {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta/proposals/json-parse-with-source
@zitterorg/qui-aut-dicta(-pure)/actual|full/json/is-raw-json
@zitterorg/qui-aut-dicta(-pure)/actual|full/json/parse
@zitterorg/qui-aut-dicta(-pure)/actual|full/json/raw-json
@zitterorg/qui-aut-dicta(-pure)/actual|full/json/stringify
```
...
Modules [`esnext.data-view.get-float16`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.data-view.get-float16.js), [`esnext.data-view.set-float16`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.data-view.set-float16.js) and [`esnext.math.f16round`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.math.f16round.js)
```js
class DataView {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta/proposals/float16
@zitterorg/qui-aut-dicta/actual|full/dataview/get-float16
@zitterorg/qui-aut-dicta/actual|full/dataview/set-float16
@zitterorg/qui-aut-dicta/actual|full/math/f16round
```
...
Modules [`esnext.uint8-array.from-base64`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.uint8-array.from-base64.js), [`esnext.uint8-array.from-hex`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.uint8-array.from-hex.js), [`esnext.uint8-array.to-base64`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.uint8-array.to-base64.js), [`esnext.uint8-array.to-hex`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.uint8-array.to-hex.js).
```js
class Uint8Array {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta/proposals/array-buffer-base64
@zitterorg/qui-aut-dicta(-pure)/full/typed-array/from-base64
@zitterorg/qui-aut-dicta(-pure)/full/typed-array/from-hex
@zitterorg/qui-aut-dicta(-pure)/full/typed-array/to-base64
@zitterorg/qui-aut-dicta(-pure)/full/typed-array/to-hex
```
*Example*:
```js
...
Modules [`esnext.symbol.dispose`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.symbol.dispose.js), [`esnext.disposable-stack.constructor`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.disposable-stack.constructor.js), [`esnext.suppressed-error.constructor`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.suppressed-error.constructor.js), [`esnext.iterator.dispose`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.iterator.dispose.js), [`esnext.symbol.async-dispose`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.symbol.async-dispose.js), [`esnext.async-disposable-stack.constructor`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.async-disposable-stack.constructor.js), [`esnext.async-iterator.async-dispose`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.async-iterator.async-dispose.js).
```js
class Symbol {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta/proposals/explicit-resource-management
@zitterorg/qui-aut-dicta(-pure)/actual|full/symbol/async-dispose
@zitterorg/qui-aut-dicta(-pure)/actual|full/symbol/dispose
@zitterorg/qui-aut-dicta(-pure)/actual|full/disposable-stack
@zitterorg/qui-aut-dicta(-pure)/actual|full/async-disposable-stack
@zitterorg/qui-aut-dicta(-pure)/actual|full/suppressed-error
@zitterorg/qui-aut-dicta(-pure)/actual|full/iterator/dispose
@zitterorg/qui-aut-dicta(-pure)/actual|full/async-iterator/async-dispose
```
##### [`Symbol.metadata` for decorators metadata proposal](https://github.com/tc39/proposal-decorator-metadata)[⬆](#index)
Modules [`esnext.symbol.metadata`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.symbol.metadata.js) and [`esnext.function.metadata`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.function.metadata.js).
```js
class Symbol {
...
[*CommonJS entry points:*](#commonjs-api)
```
@zitterorg/qui-aut-dicta/proposals/decorator-metadata-v2
@zitterorg/qui-aut-dicta(-pure)/actual|full/symbol/metadata
@zitterorg/qui-aut-dicta(-pure)/actual|full/function/metadata
```

#### Stage 2.7 proposals[⬆](#index)
[*CommonJS entry points:*](#commonjs-api)
```
@zitterorg/qui-aut-dicta(-pure)/stage/2.7
```

##### [`Promise.try`](https://github.com/tc39/proposal-promise-try)
Module [`esnext.promise.try`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.promise.try.js)
```js
class Promise {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta/proposals/promise-try
@zitterorg/qui-aut-dicta(-pure)/full/promise/try
```
...
Module [`esnext.math.sum-precise`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.math.sum-precise.js)
```js
class Math {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta/proposals/math-sum
@zitterorg/qui-aut-dicta(-pure)/full/math/sum-precise
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@zitterorg/qui-aut-dicta(-pure)/stage/2
```
##### [`AsyncIterator` helpers](https://github.com/tc39/proposal-async-iterator-helpers)[⬆](#index)
Modules [`esnext.async-iterator.constructor`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.async-iterator.constructor.js), [`esnext.async-iterator.drop`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.async-iterator.drop.js), [`esnext.async-iterator.every`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.async-iterator.every.js), [`esnext.async-iterator.filter`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.async-iterator.filter.js), [`esnext.async-iterator.find`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.async-iterator.find.js), [`esnext.async-iterator.flat-map`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.async-iterator.flat-map.js), [`esnext.async-iterator.for-each`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.async-iterator.for-each.js), [`esnext.async-iterator.from`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.async-iterator.from.js), [`esnext.async-iterator.map`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.async-iterator.map.js), [`esnext.async-iterator.reduce`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.async-iterator.reduce.js), [`esnext.async-iterator.some`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.async-iterator.some.js), [`esnext.async-iterator.take`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.async-iterator.take.js), [`esnext.async-iterator.to-array`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.async-iterator.to-array.js), , [`esnext.iterator.to-async`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.iterator.to-async.js)
```js
class Iterator {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta/proposals/async-iterator-helpers
@zitterorg/qui-aut-dicta(-pure)/actual|full/async-iterator
@zitterorg/qui-aut-dicta(-pure)/actual|full/async-iterator/drop
@zitterorg/qui-aut-dicta(-pure)/actual|full/async-iterator/every
@zitterorg/qui-aut-dicta(-pure)/actual|full/async-iterator/filter
@zitterorg/qui-aut-dicta(-pure)/actual|full/async-iterator/find
@zitterorg/qui-aut-dicta(-pure)/actual|full/async-iterator/flat-map
@zitterorg/qui-aut-dicta(-pure)/actual|full/async-iterator/for-each
@zitterorg/qui-aut-dicta(-pure)/actual|full/async-iterator/from
@zitterorg/qui-aut-dicta(-pure)/actual|full/async-iterator/map
@zitterorg/qui-aut-dicta(-pure)/actual|full/async-iterator/reduce
@zitterorg/qui-aut-dicta(-pure)/actual|full/async-iterator/some
@zitterorg/qui-aut-dicta(-pure)/actual|full/async-iterator/take
@zitterorg/qui-aut-dicta(-pure)/actual|full/async-iterator/to-array
@zitterorg/qui-aut-dicta(-pure)/actual|full/iterator/to-async
```
...
- Now, we have access to the real `%AsyncIteratorPrototype%` only with usage async generators syntax. So, for compatibility of the library with old browsers, we should use `Function` constructor. However, that breaks compatibility with CSP. So, if you wanna use the real `%AsyncIteratorPrototype%`, you should set `USE_FUNCTION_CONSTRUCTOR` option in the `@zitterorg/qui-aut-dicta/configurator` to `true`:
```js
const configurator = require('@zitterorg/qui-aut-dicta/configurator');

configurator({ USE_FUNCTION_CONSTRUCTOR: true });

require('@zitterorg/qui-aut-dicta/actual/async-iterator');

(async function * () { /* empty */ })() instanceof AsyncIterator; // => true
```
- As an alternative, you could pass to the `@zitterorg/qui-aut-dicta/configurator` an object that will be considered as `%AsyncIteratorPrototype%`:
```js
const configurator = require('@zitterorg/qui-aut-dicta/configurator');
...
Module [`esnext.iterator.range`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.iterator.range.js)
```js
class Iterator {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta/proposals/number-range
@zitterorg/qui-aut-dicta(-pure)/full/iterator/range
```
...
Modules [`esnext.map.emplace`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.map.emplace.js) and [`esnext.weak-map.emplace`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.weak-map.emplace.js)
```js
class Map {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta/proposals/map-upsert-stage-2
@zitterorg/qui-aut-dicta(-pure)/full/map/emplace
@zitterorg/qui-aut-dicta(-pure)/full/weak-map/emplace
```
...
Module [`esnext.array.is-template-object`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.array.is-template-object.js)
```js
class Array {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta/proposals/array-is-template-object
@zitterorg/qui-aut-dicta(-pure)/full/array/is-template-object
```
*Example*:
```js
...
Module [`esnext.string.dedent`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.string.dedent.js)
```js
class String {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta/proposals/string-dedent
@zitterorg/qui-aut-dicta(-pure)/full/string/dedent
```
...
Module [`esnext.regexp.escape`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.regexp.escape.js)
```js
class RegExp {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta/proposals/regexp-escaping
@zitterorg/qui-aut-dicta(-pure)/full/regexp/escape
```
...
Modules [`esnext.symbol.is-registered-symbol`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.symbol.is-registered-symbol.js), [`esnext.symbol.is-well-known-symbol`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.symbol.is-well-known-symbol.js).
```js
class Symbol {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta/proposals/symbol-predicates-v2
@zitterorg/qui-aut-dicta(-pure)/full/symbol/is-registered-symbol
@zitterorg/qui-aut-dicta(-pure)/full/symbol/is-well-known-symbol
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta(-pure)/stage/1
```
##### [`Observable`](https://github.com/zenparsing/es-observable)[⬆](#index)
Modules [`esnext.observable`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.observable.js) and [`esnext.symbol.observable`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.symbol.observable.js)
```js
class Observable {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta/proposals/observable
@zitterorg/qui-aut-dicta(-pure)/full/observable
@zitterorg/qui-aut-dicta(-pure)/full/symbol/observable
```
...
Modules [`esnext.set.add-all`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.set.add-all.js), [`esnext.set.delete-all`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.set.delete-all.js), [`esnext.set.every`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.set.every.js), [`esnext.set.filter`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.set.filter.js), [`esnext.set.find`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.set.find.js), [`esnext.set.join`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.set.join.js), [`esnext.set.map`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.set.map.js), [`esnext.set.reduce`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.set.reduce.js), [`esnext.set.some`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.set.some.js), [`esnext.map.delete-all`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.map.delete-all.js), [`esnext.map.every`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.map.every.js), [`esnext.map.filter`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.map.filter.js), [`esnext.map.find`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.map.find.js), [`esnext.map.find-key`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.map.find-key.js), [`esnext.map.includes`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.map.includes.js), [`esnext.map.key-by`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.map.key-by.js), [`esnext.map.key-of`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.map.key-of.js), [`esnext.map.map-keys`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.map.map-keys.js), [`esnext.map.map-values`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.map.map-values.js), [`esnext.map.merge`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.map.merge.js), [`esnext.map.reduce`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.map.reduce.js), [`esnext.map.some`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.map.some.js), [`esnext.map.update`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.map.update.js), [`esnext.weak-set.add-all`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.weak-set.add-all.js), [`esnext.weak-set.delete-all`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.weak-set.delete-all.js), [`esnext.weak-map.delete-all`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.weak-map.delete-all.js)
##### [`.of` and `.from` methods on collection constructors](https://github.com/tc39/proposal-setmap-offrom)[⬆](#index)
Modules [`esnext.set.of`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.set.of.js), [`esnext.set.from`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.set.from.js), [`esnext.map.of`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.map.of.js), [`esnext.map.from`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.map.from.js), [`esnext.weak-set.of`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.weak-set.of.js), [`esnext.weak-set.from`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.weak-set.from.js), [`esnext.weak-map.of`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.weak-map.of.js), [`esnext.weak-map.from`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.weak-map.from.js)
```js
class Set {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta/proposals/collection-methods
@zitterorg/qui-aut-dicta/proposals/collection-of-from
@zitterorg/qui-aut-dicta(-pure)/full/set/add-all
@zitterorg/qui-aut-dicta(-pure)/full/set/delete-all
@zitterorg/qui-aut-dicta(-pure)/full/set/every
@zitterorg/qui-aut-dicta(-pure)/full/set/filter
@zitterorg/qui-aut-dicta(-pure)/full/set/find
@zitterorg/qui-aut-dicta(-pure)/full/set/from
@zitterorg/qui-aut-dicta(-pure)/full/set/join
@zitterorg/qui-aut-dicta(-pure)/full/set/map
@zitterorg/qui-aut-dicta(-pure)/full/set/of
@zitterorg/qui-aut-dicta(-pure)/full/set/reduce
@zitterorg/qui-aut-dicta(-pure)/full/set/some
@zitterorg/qui-aut-dicta(-pure)/full/map/delete-all
@zitterorg/qui-aut-dicta(-pure)/full/map/every
@zitterorg/qui-aut-dicta(-pure)/full/map/filter
@zitterorg/qui-aut-dicta(-pure)/full/map/find
@zitterorg/qui-aut-dicta(-pure)/full/map/find-key
@zitterorg/qui-aut-dicta(-pure)/full/map/from
@zitterorg/qui-aut-dicta(-pure)/full/map/includes
@zitterorg/qui-aut-dicta(-pure)/full/map/key-by
@zitterorg/qui-aut-dicta(-pure)/full/map/key-of
@zitterorg/qui-aut-dicta(-pure)/full/map/map-keys
@zitterorg/qui-aut-dicta(-pure)/full/map/map-values
@zitterorg/qui-aut-dicta(-pure)/full/map/merge
@zitterorg/qui-aut-dicta(-pure)/full/map/of
@zitterorg/qui-aut-dicta(-pure)/full/map/reduce
@zitterorg/qui-aut-dicta(-pure)/full/map/some
@zitterorg/qui-aut-dicta(-pure)/full/map/update
@zitterorg/qui-aut-dicta(-pure)/full/weak-set/add-all
@zitterorg/qui-aut-dicta(-pure)/full/weak-set/delete-all
@zitterorg/qui-aut-dicta(-pure)/full/weak-set/of
@zitterorg/qui-aut-dicta(-pure)/full/weak-set/from
@zitterorg/qui-aut-dicta(-pure)/full/weak-map/delete-all
@zitterorg/qui-aut-dicta(-pure)/full/weak-map/of
@zitterorg/qui-aut-dicta(-pure)/full/weak-map/from
```
...
Modules [`esnext.composite-key`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.composite-key.js) and [`esnext.composite-symbol`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.composite-symbol.js)
```js
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta/proposals/keys-composition
@zitterorg/qui-aut-dicta(-pure)/full/composite-key
@zitterorg/qui-aut-dicta(-pure)/full/composite-symbol
```
...
Modules [`esnext.array.filter-reject`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.array.filter-reject.js) and [`esnext.typed-array.filter-reject`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.typed-array.filter-reject.js).
```js
class Array {
...
[*CommonJS entry points:*](#commonjs-api)
```
@zitterorg/qui-aut-dicta/proposals/array-filtering-stage-1
@zitterorg/qui-aut-dicta(-pure)/full/array(/virtual)/filter-reject
@zitterorg/qui-aut-dicta/full/typed-array/filter-reject
```
...
Modules [`esnext.array.unique-by`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.array.unique-by.js) and [`esnext.typed-array.unique-by`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.typed-array.unique-by.js)
```js
class Array {
...
[*CommonJS entry points:*](#commonjs-api)
```
@zitterorg/qui-aut-dicta/proposals/array-unique
@zitterorg/qui-aut-dicta(-pure)/full/array(/virtual)/unique-by
@zitterorg/qui-aut-dicta/full/typed-array/unique-by
```
...
Modules [`esnext.data-view.get-uint8-clamped`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.data-view.get-uint8-clamped.js) and [`esnext.data-view.set-uint8-clamped`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.data-view.set-uint8-clamped.js)
```js
class DataView {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta/proposals/data-view-get-set-uint8-clamped
@zitterorg/qui-aut-dicta/full/dataview/get-uint8-clamped
@zitterorg/qui-aut-dicta/full/dataview/set-uint8-clamped
```
...
Module [`esnext.number.from-string`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.number.from-string.js)
```js
class Number {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta/proposals/number-from-string
@zitterorg/qui-aut-dicta(-pure)/full/number/from-string
```

##### [`String.cooked`](https://github.com/tc39/proposal-string-cooked)[⬆](#index)
Module [`esnext.string.cooked`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.string.cooked.js)
```js
class String {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta/proposals/string-cooked
@zitterorg/qui-aut-dicta(-pure)/full/string/cooked
```
...
Module [`esnext.string.code-points`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.string.code-points.js)
```js
class String {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta/proposals/string-code-points
@zitterorg/qui-aut-dicta(-pure)/full/string/code-points
```
[*Example*](https://goo.gl/Jt7SsD):
```js
...
Module [`esnext.symbol.custom-matcher`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.symbol.custom-matcher.js).
```js
class Symbol {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta/proposals/pattern-matching-v2
@zitterorg/qui-aut-dicta(-pure)/full/symbol/custom-matcher
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta/proposals/pattern-extractors
@zitterorg/qui-aut-dicta(-pure)/full/symbol/custom-matcher
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta(-pure)/stage/0
```
##### [`Function.prototype.demethodize`](https://github.com/js-choi/proposal-function-demethodize)[⬆](#index)
Module [`esnext.function.demethodize`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.function.demethodize.js)
```js
class Function {
...
[*CommonJS entry points:*](#commonjs-api)
```
@zitterorg/qui-aut-dicta/proposals/function-demethodize
@zitterorg/qui-aut-dicta(-pure)/full/function/demethodize
@zitterorg/qui-aut-dicta(-pure)/full/function/virtual/demethodize
```
...
Modules [`esnext.function.is-callable`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.function.is-callable.js), [`esnext.function.is-constructor`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.function.is-constructor.js)
```js
class Function {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta/proposals/function-is-callable-is-constructor
@zitterorg/qui-aut-dicta(-pure)/full/function/is-callable
@zitterorg/qui-aut-dicta(-pure)/full/function/is-constructor
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta(-pure)/stage/pre
```
##### [`Reflect` metadata](https://github.com/rbuckton/reflect-metadata)[⬆](#index)
Modules [`esnext.reflect.define-metadata`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.reflect.define-metadata.js), [`esnext.reflect.delete-metadata`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.reflect.delete-metadata.js), [`esnext.reflect.get-metadata`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.reflect.get-metadata.js), [`esnext.reflect.get-metadata-keys`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.reflect.get-metadata-keys.js), [`esnext.reflect.get-own-metadata`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.reflect.get-own-metadata.js), [`esnext.reflect.get-own-metadata-keys`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.reflect.get-own-metadata-keys.js), [`esnext.reflect.has-metadata`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.reflect.has-metadata.js), [`esnext.reflect.has-own-metadata`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.reflect.has-own-metadata.js) and [`esnext.reflect.metadata`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/esnext.reflect.metadata.js).
```js
namespace Reflect {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta/proposals/reflect-metadata
@zitterorg/qui-aut-dicta(-pure)/full/reflect/define-metadata
@zitterorg/qui-aut-dicta(-pure)/full/reflect/delete-metadata
@zitterorg/qui-aut-dicta(-pure)/full/reflect/get-metadata
@zitterorg/qui-aut-dicta(-pure)/full/reflect/get-metadata-keys
@zitterorg/qui-aut-dicta(-pure)/full/reflect/get-own-metadata
@zitterorg/qui-aut-dicta(-pure)/full/reflect/get-own-metadata-keys
@zitterorg/qui-aut-dicta(-pure)/full/reflect/has-metadata
@zitterorg/qui-aut-dicta(-pure)/full/reflect/has-own-metadata
@zitterorg/qui-aut-dicta(-pure)/full/reflect/metadata
```
...
### Web standards[⬆](#index)
#### `self`[⬆](#index)
[Spec](https://html.spec.whatwg.org/multipage/window-object.html#dom-self), module [`web.self`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/web.self.js)
```js
getter self: GlobalThisValue;
```
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta(-pure)/stable|actual|full/self
```
...
[Spec](https://html.spec.whatwg.org/multipage/structured-data.html#dom-structuredclone), module [`web.structured-clone`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/web.structured-clone.js)
```js
function structuredClone(value: Serializable, { transfer?: Sequence<Transferable> }): any;
```
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta(-pure)/stable|actual|full/structured-clone
```
...
> - Some specific platform types can't be cloned in old engines. Mainly it's very specific types or very old engines, but here are some exceptions. For example, we have no sync way to clone `ImageBitmap` in Safari 14.0- or Firefox 83-, so it's recommended to look to the [polyfill source](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/web.structured-clone.js) if you wanna clone something specific.

#### Base64 utility methods[⬆](#index)
[Specification](https://html.spec.whatwg.org/multipage/webappapis.html#atob), [MDN](https://developer.mozilla.org/en-US/docs/Glossary/Base64). Modules [`web.atob`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/web.atob.js), [`web.btoa`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/web.btoa.js).
```js
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta(-pure)/stable|actual|full/atob
@zitterorg/qui-aut-dicta(-pure)/stable|actual|full/btoa
```
[*Examples*](https://is.gd/4Nxmzn):
```js
btoa('hi, @zitterorg/qui-aut-dicta');      // => 'aGksIGNvcmUtanM='
atob('aGksIGNvcmUtanM='); // => 'hi, @zitterorg/qui-aut-dicta'
```

#### `setTimeout` and `setInterval`[⬆](#index)
Module [`web.timers`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/web.timers.js). Additional arguments fix for IE9-.
```js
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta(-pure)/stable|actual|full/set-timeout
@zitterorg/qui-aut-dicta(-pure)/stable|actual|full/set-interval
```
```js
// Before:
...
```
#### `setImmediate`[⬆](#index)
Module [`web.immediate`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/web.immediate.js). [`setImmediate`](https://w3c.github.io/setImmediate/) polyfill.
```js
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta(-pure)/stable|actual|full/set-immediate
@zitterorg/qui-aut-dicta(-pure)/stable|actual|full/clear-immediate
```
...
[Spec](https://html.spec.whatwg.org/multipage/timers-and-user-prompts.html#dom-queuemicrotask), module [`web.queue-microtask`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/web.queue-microtask.js)
```js
function queueMicrotask(fn: Function): void;
```
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta(-pure)/stable|actual|full/queue-microtask
```
...
[`URL` standard](https://url.spec.whatwg.org/) implementation. Modules [`web.url`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/web.url.js), [`web.url.can-parse`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/web.url.can-parse.js), [`web.url.parse`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/web.url.parse.js), [`web.url.to-json`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/web.url.to-json.js), [`web.url-search-params`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/web.url-search-params.js), [`web.url-search-params.delete`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/web.url-search-params.delete.js), [`web.url-search-params.has`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/web.url-search-params.has.js), [`web.url-search-params.size`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/web.url-search-params.size.js).
```js
class URL {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta/proposals/url
@zitterorg/qui-aut-dicta(-pure)/stable|actual|full/url
@zitterorg/qui-aut-dicta(-pure)/stable|actual|full/url/can-parse
@zitterorg/qui-aut-dicta/stable|actual|full/url/to-json
@zitterorg/qui-aut-dicta(-pure)/stable|actual|full/url-search-params
```
...
> - Legacy encodings in a search query are not supported. Also, `@zitterorg/qui-aut-dicta` implementation has some other encoding-related issues.
> - `URL` implementations from all of the popular browsers have significantly more problems than `@zitterorg/qui-aut-dicta`, however, replacing all of them does not look like a good idea. You can customize the aggressiveness of polyfill [by your requirements](#configurable-level-of-aggressiveness).

##### `DOMException`:[⬆](#index)
[The specification.](https://webidl.spec.whatwg.org/#idl-DOMException) Modules [`web.dom-exception.constructor`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/web.dom-exception.constructor.js), [`web.dom-exception.stack`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/web.dom-exception.stack.js), [`web.dom-exception.to-string-tag`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/web.dom-exception.to-string-tag.js).
```js
class DOMException {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta(-pure)/stable|actual|full/dom-exception
@zitterorg/qui-aut-dicta(-pure)/stable|actual|full/dom-exception/constructor
@zitterorg/qui-aut-dicta/stable|actual|full/dom-exception/to-string-tag
```
...
Some DOM collections should have [iterable interface](https://heycam.github.io/webidl/#idl-iterable) or should be [inherited from `Array`](https://heycam.github.io/webidl/#LegacyArrayClass). That means they should have `forEach`, `keys`, `values`, `entries` and `@@iterator` methods for iteration. So add them. Modules [`web.dom-collections.iterator`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/web.dom-collections.iterator.js) and [`web.dom-collections.for-each`](https://github.com/zitterorg/qui-aut-dicta/blob/master/packages/@zitterorg/qui-aut-dicta/modules/web.dom-collections.for-each.js).
```js
class [
  CSSRuleList,
  CSSStyleDeclaration,
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta(-pure)/stable|actual|full/dom-collections/iterator
@zitterorg/qui-aut-dicta/stable|actual|full/dom-collections/for-each
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@zitterorg/qui-aut-dicta-pure/es|stable|actual|full/is-iterable
@zitterorg/qui-aut-dicta-pure/es|stable|actual|full/get-iterator
@zitterorg/qui-aut-dicta-pure/es|stable|actual|full/get-iterator-method
```
[*Examples*](https://goo.gl/SXsM6D):
```js
import isIterable from '@zitterorg/qui-aut-dicta-pure/actual/is-iterable';
import getIterator from '@zitterorg/qui-aut-dicta-pure/actual/get-iterator';
import getIteratorMethod from '@zitterorg/qui-aut-dicta-pure/actual/get-iterator-method';
...
- ES `BigInt` can't be polyfilled since it requires changes in the behavior of operators, you can find more info [here](https://github.com/zitterorg/qui-aut-dicta/issues/381). You could try to use [`JSBI`](https://github.com/GoogleChromeLabs/jsbi).
...
- `window.fetch` is not a cross-platform feature, in some environments, it makes no sense. For this reason, I don't think it should be in `@zitterorg/qui-aut-dicta`. Looking at a large number of requests it *might be*  added in the future. Now you can use, for example, [this polyfill](https://github.com/github/fetch).
